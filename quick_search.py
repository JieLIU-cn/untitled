...
def quick_search(sequence, left, right, k):
    ...
    if k == pivot_index:
        ...
        return quick_search(sequence, left, pivot_index, k)
    else:
...
if __name__ == '__main__':
    ...
    k = int(input("Find the k'th smallest number in the sequence, k="))-1
    value = quick_search(sequence, left, right, k)
    print("The {}'th smallest number in the sequence is: {}".format(k+1, value))
